 ...
 * @author toshiba
 */
import Class.Recherche;
import Class.Send_Request;
...
public class Rechercher extends javax.swing.JFrame{
    ...
    String username;
    Socket client;
    public Rechercher(String username,Socket client) {
         initComponents();
    ...
    if(!usernam.isEmpty()){
        try {
            new Recherche(jTable1,usernam,client);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
                  String usernam = (String) jTable1.getValueAt(jTable1.getSelectedRow(),0);
                  try {
                      new Send_Request(username,usernam,client);
                  }catch (IOException ex) {                         
                  }
