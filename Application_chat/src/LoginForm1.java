...
try{
    ...
    if(!user.isEmpty() && !pass.isEmpty()) {
                ...
                new Logiin_and_register(user,pass,client);
                BufferedReader sing = new BufferedReader(new InputStreamReader(client.getInputStream()));
                String cond=sing.readLine();
        if(cond.equals("true")){
                new Client1(user,client).setVisible(true);
                this.setVisible(false);
        }else{
                JOptionPane.showMessageDialog(null,"username ou password est incorrect !","echec",JOptionPane.INFORMATION_MESSAGE);     
        }
    }else{
                JOptionPane.showMessageDialog(null,"merci de remplir tout les champ","echec",JOptionPane.INFORMATION_MESSAGE);    
    }
